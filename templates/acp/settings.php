...
<tr><td>OZ Hide Time</td><td><input type="text" name="ozhide" value="<?= $settings['oz hide'] ?>" /></td><td>Time (in hours) the Original Zombies are allowed to kill without wearing a bandana</td></tr>
